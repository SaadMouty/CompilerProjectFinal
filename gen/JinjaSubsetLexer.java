...
public class JinjaSubsetLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"JINJA_COMMENT", "EXPR_OPEN", "EXPR_CLOSE", "STMT_OPEN", "STMT_CLOSE", 
			"FOR", "ENDFOR", "IF", "ENDIF", "IN", "TRUE", "FALSE", "OR", "AND", "EQEQ", 
			"NEQ", "LE", "GE", "LT", "GT", "PLUS", "MINUS", "DOT", "LPAREN", "RPAREN", 
			"NUMBER", "STRING", "IDENTIFIER", "WS", "TEXT", "DIGIT", "ESC", "HEX"
		};
	}
	...
	public JinjaSubsetLexer(CharStream input) {
		super(input);
